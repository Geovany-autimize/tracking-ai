 ...
 */
export async function getAvailableCredits(customerId: string, fallbackPlanId?: string): Promise<number> {
 ...
 */
export async function getTotalPurchasedCredits(customerId: string, fallbackPlanId?: string): Promise<number> {
